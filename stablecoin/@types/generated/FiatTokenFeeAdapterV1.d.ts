...
export interface FiatTokenFeeAdapterV1Contract
  extends Truffle.Contract<FiatTokenFeeAdapterV1Instance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<FiatTokenFeeAdapterV1Instance>;
}

type AllEvents = never;

export interface FiatTokenFeeAdapterV1Instance
