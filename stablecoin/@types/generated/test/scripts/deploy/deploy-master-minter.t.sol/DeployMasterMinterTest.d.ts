...
export interface DeployMasterMinterTestContract
  extends Truffle.Contract<DeployMasterMinterTestInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<DeployMasterMinterTestInstance>;
}
...
export interface DeployMasterMinterTestInstance
