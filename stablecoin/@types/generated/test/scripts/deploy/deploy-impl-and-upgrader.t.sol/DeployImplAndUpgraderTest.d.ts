...
export interface DeployImplAndUpgraderTestContract
  extends Truffle.Contract<DeployImplAndUpgraderTestInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<DeployImplAndUpgraderTestInstance>;
}
...
export interface DeployImplAndUpgraderTestInstance
  ...
  test_DeployImplAndUpgraderWithAllEnvConfigured: {
    (txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(txDetails?: Truffle.TransactionDetails): Promise<void>;
  ...
  test_DeployImplAndUpgraderWithPredeployedImpl: {
    (txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(txDetails?: Truffle.TransactionDetails): Promise<void>;
