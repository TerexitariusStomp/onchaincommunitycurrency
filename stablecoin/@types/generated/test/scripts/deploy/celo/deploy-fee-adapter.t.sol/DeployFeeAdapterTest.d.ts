...
export interface DeployFeeAdapterTestContract
  extends Truffle.Contract<DeployFeeAdapterTestInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<DeployFeeAdapterTestInstance>;
}
...
export interface DeployFeeAdapterTestInstance extends Truffle.ContractInstance {
