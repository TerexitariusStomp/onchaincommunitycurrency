...
export interface DeployFiatTokenCeloTestContract
  extends Truffle.Contract<DeployFiatTokenCeloTestInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<DeployFiatTokenCeloTestInstance>;
}
...
export interface DeployFiatTokenCeloTestInstance
