...
export interface MockFiatTokenCeloWithExposedFunctionsContract
  extends Truffle.Contract<MockFiatTokenCeloWithExposedFunctionsInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<MockFiatTokenCeloWithExposedFunctionsInstance>;
}
...
export interface FeeCallerChanged {
...
export interface MockFiatTokenCeloWithExposedFunctionsInstance
  ...
  feeCaller(txDetails?: Truffle.TransactionDetails): Promise<string>;
  ...
  updateFeeCaller: {
    (_newFeeCaller: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(
      _newFeeCaller: string,
      txDetails?: Truffle.TransactionDetails
    ): Promise<void>;
    sendTransaction(
      _newFeeCaller: string,
