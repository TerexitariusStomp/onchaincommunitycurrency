...
export interface MasterMinterContract
  extends Truffle.Contract<MasterMinterInstance> {
  "new"(
    _minterManager: string,
    meta?: Truffle.TransactionDetails
  ): Promise<MasterMinterInstance>;
}
...
export interface MasterMinterInstance extends Truffle.ContractInstance {
  configureController: {
    (
      _controller: string,
      _worker: string,
