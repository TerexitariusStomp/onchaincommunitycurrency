...
export interface FiatTokenV2_1Contract
  extends Truffle.Contract<FiatTokenV2_1Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<FiatTokenV2_1Instance>;
}
...
export interface FiatTokenV2_1Instance extends Truffle.ContractInstance {
