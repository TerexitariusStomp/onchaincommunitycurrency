...
export interface FiatTokenV2_2Contract
  extends Truffle.Contract<FiatTokenV2_2Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<FiatTokenV2_2Instance>;
}
...
export interface FiatTokenV2_2Instance extends Truffle.ContractInstance {
