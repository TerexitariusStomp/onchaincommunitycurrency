...
export interface FiatTokenCeloV2_2Contract
  extends Truffle.Contract<FiatTokenCeloV2_2Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<FiatTokenCeloV2_2Instance>;
}
...
export interface FiatTokenCeloV2_2Instance extends Truffle.ContractInstance {
