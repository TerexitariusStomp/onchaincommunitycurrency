...
export interface FiatTokenV1_1Contract
  extends Truffle.Contract<FiatTokenV1_1Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<FiatTokenV1_1Instance>;
}
...
export interface FiatTokenV1_1Instance extends Truffle.ContractInstance {
  allowance(
    owner: string,
    spender: string,
