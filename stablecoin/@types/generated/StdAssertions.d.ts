...
export interface StdAssertionsContract
  extends Truffle.Contract<StdAssertionsInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<StdAssertionsInstance>;
}
...
export interface StdAssertionsInstance extends Truffle.ContractInstance {
