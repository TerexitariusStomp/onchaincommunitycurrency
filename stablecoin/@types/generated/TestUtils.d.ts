...
export interface TestUtilsContract extends Truffle.Contract<TestUtilsInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<TestUtilsInstance>;
}
...
export interface TestUtilsInstance extends Truffle.ContractInstance {
